            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero-content">
                        ...
                        <p><span>Embark on a</span> journey of opportunity and success, <span>in the Netherlands</span> with Polticventure.</p>
                        {{-- <div class="counter-area">
                            <div class="row g-lg-4 g-md-5 gy-5 justify-content-center">
                                <x-home.counter-card odometer="20243" icon="job2" label="Live Jobs" />

                                <x-home.counter-card odometer="804" icon="companies" label="Companies">
                                    <span>+</span>
                                </x-home.counter-card>

                                <x-home.counter-card odometer="370" icon="candidates" label="Candidates">
                                    <span>+</span>
                                </x-home.counter-card>

                                <x-home.counter-card odometer="200" icon="new-jobs" label="Processed Visas">
                                    <span>+</span>
                                </x-home.counter-card>
            ...
            <div
                ...
                <div class="col">
                    <div class="single-category">
                        <div class="category-top">
                            <div class="icon">
                                <img
                                    src="/assets/images/icon/account-finance.svg"
                                    alt
                                >
                            </div>
                            <div class="sl-no">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Account &
                                    Finance</a></h5>
                ...
                <div class="col">
                    <div class="single-category">
                        <div class="category-top">
                            <div class="icon">
                                <img
                                    src="/assets/images/icon/technology.svg"
                                    alt
                                >
                            </div>
                            <div class="sl-no">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Technology</a></h5>
                ...
                <div class="col">
                    <div class="single-category">
                        <div class="category-top">
                            <div class="icon">
                                <img
                                    src="/assets/images/icon/medical.svg"
                                    alt
                                >
                            </div>
                            <div class="sl-no">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Medical & Nurse</a></h5>
                ...
                <div class="col">
                    <div class="single-category">
                        <div class="category-top">
                            <div class="icon">
                                <img
                                    src="/assets/images/icon/marketing.svg"
                                    alt
                                >
                            </div>
                            <div class="sl-no">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Marketing &
                                    Sales</a></h5>
                ...
                <div class="col">
                    <div class="single-category">
                        <div class="category-top">
                            <div class="icon">
                                <img
                                    src="/assets/images/icon/design-job.svg"
                                    alt
                                >
                            </div>
                            <div class="sl-no">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Design Jobs</a></h5>
                ...
                <div class="col">
                    <div class="single-category">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Transportation</a></h5>
                ...
                <div class="col">
                    <div class="single-category">
                        <div class="category-top">
                            <div class="icon">
                                <img
                                    src="/assets/images/icon/devlopment.svg"
                                    alt
                                >
                            </div>
                            <div class="sl-no">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Development</a></h5>
                ...
                <div class="col">
                    <div class="single-category">
                        <div class="category-top">
                            <div class="icon">
                                <img
                                    src="/assets/images/icon/receotionist.svg"
                                    alt
                                >
                            </div>
                            <div class="sl-no">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Receptionist Job</a></h5>
                ...
                <div class="col">
                    <div class="single-category">
                        <div class="category-top">
                            <div class="icon">
                                <img
                                    src="/assets/images/icon/non-profit-org.svg"
                                    alt
                                >
                            </div>
                            <div class="sl-no">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Non-Profit Orag.</a></h5>
                ...
                <div class="col">
                    <div class="single-category">
                        <div class="category-top">
                            <div class="icon">
                                <img
                                    src="/assets/images/icon/architect.svg"
                                    alt
                                >
                            </div>
                            <div class="sl-no">
                        ...
                        <div class="category-content">
                            <h5><a href="job-listing1.html">Architect Jobs</a></h5>
