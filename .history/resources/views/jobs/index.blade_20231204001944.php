                ...
                <div class="col-lg-4 order-lg-1 order-2">
                    <div class="job-sidebar">
                        ...
                        <div class="job-widget mb-20">
                            <div class="check-box-item">
                                <h5 class="job-widget-title">Type of
                                    Employments</h5>
                                <div class="checkbox-container">
                                    <ul>
                                        <li>
                        ...
                        <div class="job-widget mb-20">
                            <div class="check-box-item">
                                <h5 class="job-widget-title mb-15">Salary
                                    Range</h5>
                        ...
                        <div class="job-widget mb-20">
                            <div class="check-box-item">
                                <h5 class="job-widget-title mb-10">Date of
                                    Post</h5>
                                <ul class="tags">
                                    ...
                                    <li><a href="job-listing1.html">Data
                                            Analyst,</a></li>
                        ...
                        <div class="job-widget-btn">
                            <a class="primry-btn-2 lg-btn text-center"
                                href="#">Go to Job Alert</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="job-listing-wrrap">
                        <div class="row g-4 mb-25">
                            <div class="col-lg-6 d-flex align-items-center">
                                <p class="show-item">Showing results 10 in
                                    200 jobs list</p>
                            </div>
                            <div
                                class="col-lg-6 d-flex align-items-center justify-content-lg-end">
                                                ...
                                                <div class="company-details">
                                                    <div
                                                        ...
                                                        <h5><a
                                                                ...
                                                                Developer</a></h5>
                                                        <p><a
                                                                href="company-details.html">Marko
                                                                Land Conpany</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="company-area">
                                                ...
                                                <div class="company-details">
                                                    <div
                                                        class="name-location">
                                                        <h5><a
                                                                href="job-details.html">Junior
                                                                React
                                                                Developer</a></h5>
                                                        <p><a
                                                                href="company-details.html">UI.UX
                                                                Company</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="company-area">
                                                ...
                                                <div class="company-details">
                                                    <div
                                                        class="name-location">
                                                        <h5><a
                                                                href="job-details.html">Mern
                                                                Stack
                                                                Developer</a></h5>
                                                        <p><a
                                                                href="company-details.html">Germain
                                                                Group Ltd</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="company-details">
                                                    <div
                                                        ...
                                                        <h5><a
                                                                ...
                                                                Developer</a></h5>
                                                        <p><a
                                                                href="company-details.html">Bistro.Tech
                                                                Ltd</a></p>
                                                    </div>
                                                </div>
                                            </div>
