                    ...
                    >
                        ...
                        >
                            <button
                                ...
                                aria-controls="home"
                                aria-selected="true"
                            ><span></span>Basic Information:</button>
                        </li>
                        <li
                            class="nav-item"
                            role="presentation"
                        ...
                        >
                            <button
                                ...
                                aria-selected="false"
                            ><span></span>Professional Info</button>
                        </li>
                    </ul> --}}
                    <div
                        class="tab-content"
                            ...
                            <form class="edit-profile-form profile-form  mb-60">
                                <div class="row">
                                                ...
                                                <div class="company-details">
                                                    <div class="name-location">
                                                        <h5><a href="job-details.html">UI/UX
                                                                Engineer</a> <span>Full
                                                                Time, Remote<span></span></span></h5>
                                                        <ul>
                                                            <li><a
                                                                    href="company-details.html">Norland
                                                                    Company</a></li>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group files mb-25">
                                          <label>Upload Your Application Later </label>
                                          <input type="file" class="form-control" multiple="">
                                        </div>
