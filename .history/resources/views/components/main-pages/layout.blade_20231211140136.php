...
<html lang="en">
    ...
    <body data-anm=".anm">
        ...
        <div class="page-wrapper">
                                        ...
                                        <div class="mega-menu-bar row pt-0">
                                            ...
                                            <div class="column col-lg-3 col-md-3 col-sm-12">
                                                <ul>
                                                    ...
                                                    <li class="current"><a href="index-13.html">Home Page 13</a></li>
                            ...
                            <div class="inner-column">
                                ...
                                >
                                    ...
                                    <a
                                        href="#"
                                        class="upload-cv"
                                    ><span class="icon flaticon-file"></span> Upload your CV</a>
                                </div>
                            </div>
                        </div>
            ...
            <section class="layout-pt-120 layout-pb-60">
                <div class="auto-container">
                    <div class="row justify-content-between align-items-end">
                        <div class="col-lg-6">
                            <div class="">
                                <h2 class="fw-700">Jobs by category</h2>
                        ...
                        <div class="col-auto">
                            <a
                                href="#"
                                class="button-icon -arrow text-dark-blue"
                            >
                                Browse All
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="content-column mb-0 col-xl-5 col-lg-6 col-md-12 col-sm-12">
                            <div class="wow fadeInLeft">
                                <div class="sec-title">
                                    <h2 class="fw-700">Professional CV is your ticket to the dream job</h2>
                                    <div class="text mt-30">To start searching for jobs, you can attend job fairs online
                                        or in person, use job boards and career websites or reach out directly to
                                        recruiters in a targeted company to broaden your network.</div>
                                </div>
                                <a
                                    href="#"
                            ...
                            <div class="outer-box job-block-five-separated">
                                    ...
                                    <div class="inner-box">
                                        <div class="content">
                                            <span class="company-logo"><img
                                                    src="/images/resource/company-logo/4-1.png"
                                                    alt=""
                                                ></span>
                                        ...
                                        <ul class="job-other-info">
                                            <li class="time mb-0">Full Time</li>
                                        </ul>
                                        <a
                                            href="#"
                                            class="theme-btn btn-dark-blue"
                                        >Apply Job</a>
                                    </div>
                                </div>
                                ...
                                <div class="job-block-five">
                                    <div class="inner-box">
                                        <div class="content">
                                            <span class="company-logo"><img
                                                    src="/images/resource/company-logo/4-2.png"
                                                    alt=""
                                                ></span>
                                ...
                                <div class="job-block-five">
                                    <div class="inner-box">
                                        <div class="content">
                                            <span class="company-logo"><img
                                                    src="/images/resource/company-logo/4-3.png"
                                                    alt=""
                                                ></span>
                                ...
                                <div class="job-block-five">
                                    <div class="inner-box">
                                        <div class="content">
                                            <span class="company-logo"><img
                                                    src="/images/resource/company-logo/4-4.png"
                                                    alt=""
                                                ></span>
                                ...
                                <div class="job-block-five">
                                    <div class="inner-box">
                                        <div class="content">
                                            <span class="company-logo"><img
                                                    src="/images/resource/company-logo/4-5.png"
                                                    alt=""
                                                ></span>
                ...
                <div class="auto-container">
                    <div class="row wow fadeInUp">
                        ...
                        <div class="banner-style-one -type-2 col-lg-6 col-md-12 col-sm-12">
                            <div
                                class="inner-box"
                                style="background-image:url('images/index-13/banner/bg-1.png')"
                            >
                                <div class="content">
                                    <h3>Employers</h3>
                                    <p>Sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt. Labore
                                        et dolore nostrud exercitation.</p>
                                    <a
                                        href="#"
                                ...
                                <figure class="image"><img
                                        src="/images/resource/employ.png"
                                        alt=""
                                    ></figure>
                            </div>
                        </div>
                        ...
                        <div class="banner-style-two -type-2 col-lg-6 col-md-12 col-sm-12">
                            <div
                                class="inner-box"
                                style="background-image:url('images/index-13/banner/bg-2.png')"
                            >
                                <div class="content">
                                    <h3 class="color-dark-1">Candidate</h3>
                                    <p class="color-dark-2">Sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt. Labore et dolore nostrud exercitation.</p>
                                    <a
                                        href="#"
                                        class="theme-btn btn-style-five color-dark-1"
                                    >Register Account</a>
                                </div>
                                <figure class="image"><img
                                        src="/images/resource/candidate.png"
                                        alt=""
                                    ></figure>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-between align-items-end">
                        <div class="col-lg-6">
                            <div class="sec-title mb-0">
                                ...
                                <div class="text">Some of the companies we've helped recruit excellent applicants over
                                    the years.</div>
                            </div>
                        </div>
                        ...
                        <div class="col-auto">
                            <a
                                href="#"
                                class="button -arrow text-dark-blue"
                            >
                                Browse
                                <span class="fa fa-angle-right"></span>
                            </a>
                    ...
                    <div class="carousel-outer pt-50 wow fadeInUp">
                        <div class="companies-carousel owl-carousel owl-theme default-dots">
                            ...
                            <div class="company-block">
                                <div class="inner-box">
                                    <figure class="image"><img
                                            src="/images/resource/company-1.png"
                                            alt=""
                                        ></figure>
                            ...
                            <div class="company-block">
                                <div class="inner-box">
                                    <figure class="image"><img
                                            src="/images/resource/company-3.png"
                                            alt=""
                                        ></figure>
                            ...
                            <div class="company-block">
                                <div class="inner-box">
                                    <figure class="image"><img
                                            src="/images/resource/company-4.png"
                                            alt=""
                                        ></figure>
                    ...
                    <div class="row grid-base wow fadeInUp">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="pricingCard -type-2">
                                ...
                                <div class="pricingCard__img">
                                    <img
                                        src="/images/index-13/pricing/1.svg"
                                        alt="/images"
                                    >
                                </div>

                                <div class="pricingCard__text text-left">Standard listing submission, active for 30 days
                                </div>
                                ...
                                <div class="pricingCard__btn">
                                    <a
                                        href="#"
                                        class="theme-btn btn-style-modern"
                                    >
                                        Join This Plan
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="pricingCard -type-2">
                                ...
                                <div class="pricingCard__img">
                                    <img
                                        src="/images/index-13/pricing/2.svg"
                                        alt="/images"
                                    >
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="pricingCard -type-2">
                                ...
                                <div class="pricingCard__img">
                                    <img
                                        src="/images/index-13/pricing/3.svg"
                                        alt="/images"
                                    >
                                </div>
            ...
            <!-- Subscribe Section -->
            <section class="subscribe-section-two -type-3">
                <div
                    class="background-image"
                    style="background-image: url(/images/index-13/cta/bg.png);"
                ></div>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-5">
                            <div class="sec-title light mb-0">
                                ...
                                <div class="text text-white">New features. New appearance. No risk and<br> credit card
                                    required.</div>
                        ...
                        <ul class="sponsors-carousel owl-carousel owl-theme">
                            <li class="slide-item">
                                <figure class="image-box"><a href="#"><img
                                            src="/images/index-11/clients/1.svg"
                                            alt=""
                                        ></a></figure>
                            </li>
                            <li class="slide-item">
                                <figure class="image-box"><a href="#"><img
                                            src="/images/index-11/clients/2.svg"
                                            alt=""
                                        ></a></figure>
                            </li>
                            <li class="slide-item">
                                <figure class="image-box"><a href="#"><img
                                            src="/images/index-11/clients/3.svg"
                                            alt=""
                                        ></a></figure>
                            </li>
                            <li class="slide-item">
                                <figure class="image-box"><a href="#"><img
                                            src="/images/index-11/clients/4.svg"
                                            alt=""
                                        ></a></figure>
                            </li>
                            <li class="slide-item">
                                <figure class="image-box"><a href="#"><img
                                            src="/images/index-11/clients/5.svg"
                                            alt=""
                                        ></a></figure>
                            </li>
                            <li class="slide-item">
                                <figure class="image-box"><a href="#"><img
                                            src="/images/index-11/clients/6.svg"
                                            alt=""
                                        ></a></figure>
                            </li>
                            <li class="slide-item">
                                <figure class="image-box"><a href="#"><img
                                            src="/images/index-11/clients/7.svg"
                                            alt=""
                                        ></a></figure>
                            </li>
                        </ul>
