        ...
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="sec-title text-center">
                    ...
                    <div class="text">With Helpnow as your guide, you can:
                    </div>
                </div>
            </div>
        </div>
            ...
            @php
                $abilities = [
                    ...
                    [
                        ...
                        "content" => "Settling in a new country can be daunting, but with Helpnow, you're never alone. We offer practical assistance with everything from finding your ideal home and navigating transportation systems to accessing essential services and immersing yourself in the vibrant Dutch culture."
                    ],
                    ...
                    [
                        ...
                        "content" => "Communication is key, and at Helpnow, we speak your language. Our team offers multilingual support, ensuring you feel understood and empowered throughout your journey."
                    ],
                ];
            @endphp
