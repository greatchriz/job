...
<!-- Mirrored from creativelayers.net/themes/superio/index-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Dec 2023 07:34:47 GMT -->
<head>
  <meta charset="utf-8">
  <title>Superio | Just another HTML Template | Home Page 10</title>
...
<body data-anm=".anm">
  ...
  <div class="page-wrapper">
                    ...
                    <div class="mega-menu-bar row pt-0">
                      ...
                      <div class="column col-lg-3 col-md-3 col-sm-12">
                        <ul>
                          ...
                          <li class="current"><a href="index-10.html">Home Page 10</a></li>
                        </ul>
                      </div>
            ...
            <div class="row wow fadeInUp">
              ...
              <div class="feature-block-two col-lg-4 col-md-4 col-sm-12">
                <div class="inner-box">
                  ...
                  <span class="count">(2 open positions)</span>
                </div>
              </div>
              ...
              <div class="feature-block-two col-lg-4 col-md-4 col-sm-12">
                <div class="inner-box">
                  ...
                  <h4>Marketing</h4>
                  <span class="count">(86 open positions)</span>
                </div>
              </div>
              ...
              <div class="feature-block-two col-lg-4 col-md-4 col-sm-12">
                <div class="inner-box">
                  ...
                  <h4>Design</h4>
                  <span class="count">(43 open positions)</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="testimonial-section-four" style="background-image: url(/images/background/11.png);">
      <div class="container-fluid">
        <!-- Sec Title -->
    ...
    <!-- Candidates Section -->
    <section class="candidates-section alternate">
      <div class="auto-container">
        <div class="sec-title">
          ...
          <div class="candidates-carousel owl-carousel owl-theme default-dots">
            ...
            <div class="candidate-block">
              <div class="inner-box">
                ...
                <a href="#" class="theme-btn btn-style-eight">View Profile</a>
              </div>
            </div>
        ...
        <div class="row wow fadeInUp">
          ...
          <div class="column col-xl-6 col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="news-block">
              <div class="inner-box">
                <div class="image-box">
                  <figure class="image"><img src="images/resource/news-3-5.png" alt="" /></figure>
                </div>
          ...
          <div class="grid col-xl-6 col-lg-12 col-md-12 col-sm-12">
            <div class="row">
              <!-- News Block -->
              <div class="news-block col-lg-6 col-md-6 col-sm-12">
                <div class="inner-box">
                  <div class="image-box">
                    <figure class="image"><img src="images/resource/news-3-1.png" alt="" /></figure>
                  </div>
                  <div class="lower-content">
                    <ul class="post-meta">
                      <li><a href="#">August 31, 2021</a></li>
              ...
              <div class="news-block col-lg-6 col-md-6 col-sm-12">
                <div class="inner-box">
                  <div class="image-box">
                    <figure class="image"><img src="images/resource/news-3-2.png" alt="" /></figure>
                  </div>
                  <div class="lower-content">
                    <ul class="post-meta">
                      <li><a href="#">August 31, 2021</a></li>
                    ...
                    <h3><a href="blog-single.html">An Overworked Newspaper</a></h3>
                  </div>
                </div>
              </div>
              ...
              <div class="news-block col-lg-6 col-md-6 col-sm-12">
                <div class="inner-box">
                  <div class="image-box">
                    <figure class="image"><img src="images/resource/news-3-3.png" alt="" /></figure>
                  </div>
                  <div class="lower-content">
                    <ul class="post-meta">
                      <li><a href="#">August 31, 2021</a></li>
                    ...
                    <h3><a href="blog-single.html">Create your adventure</a></h3>
                  </div>
                </div>
              </div>
              ...
              <div class="news-block col-lg-6 col-md-6 col-sm-12">
                <div class="inner-box">
                  <div class="image-box">
                    <figure class="image"><img src="images/resource/news-3-4.png" alt="" /></figure>
                  </div>
                  <div class="lower-content">
                    <ul class="post-meta">
                      <li><a href="#">August 31, 2021</a></li>
                    ...
                    <h3><a href="blog-single.html">5 basic tips for colors</a></h3>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row wow fadeInUp">
          <div class="column col-lg-3 col-md-6 col-sm-12">
            ...
            <ul class="links-list">
              ...
              <li><a href="#">Human Resources Jobs</a></li>
              <li><a href="#">Construction Jobs</a></li>
              <li><a href="#">Transportation Jobs</a></li>
          ...
          <div class="column col-lg-3 col-md-6 col-sm-12">
            ...
            <ul class="links-list">
              ...
              <li><a href="#">Receptionist Jobs</a></li>
              <li><a href="#">Online Teaching Jobs</a></li>
              <li><a href="#">Medical Assistant Jobs</a></li>
              <li><a href="#">Delivery Driver Jobs</a></li>
              <li><a href="#">Security Guard Jobs</a></li>
              <li><a href="#">Transportation Jobs</a></li>
            </ul>
          </div>
          ...
          <div class="column col-lg-3 col-md-6 col-sm-12">
            <h4>Popular Job Categories</h4>
            <ul class="links-list">
              <li><a href="#">NYC, NY Jobs</a></li>
              <li><a href="#">Houston, TX Jobs</a></li>
              <li><a href="#">Los Angeles, CA Jobs</a></li>
              <li><a href="#">Atlanta, GA Jobs</a></li>
              <li><a href="#">Las Vegas, NV Jobs</a></li>
              <li><a href="#">San Antonio, TX Jobs</a></li>
              <li><a href="#">Dallas, TX Jobs</a></li>
            </ul>
          </div>
          ...
          <div class="column col-lg-3 col-md-6 col-sm-12">
            <h4>Popular Job Categories</h4>
            <ul class="links-list">
              <li><a href="#">Coca Cola Jobs</a></li>
              <li><a href="#">PepsiCo Jobs</a></li>
              <li><a href="#">Brookdale Senior Living Jobs</a></li>
              <li><a href="#">Manpower Jobs</a></li>
              <li><a href="#">Accenture Jobs</a></li>
              <li><a href="#">US Federal Government Jobs</a></li>
              <li><a href="#">Amazon Jobs</a></li>
            </ul>
          </div>
        </div>
      </div>
...
<!-- Mirrored from creativelayers.net/themes/superio/index-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Dec 2023 07:34:50 GMT -->
</html>
