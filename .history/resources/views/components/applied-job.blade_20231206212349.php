                ...
                <div class="company-area">
                    ...
                    <div class="company-details">
                        <div class="name-location">
                            <h5><a href="job-details.html">{{ $jobApplication->job->company->name }}</a></h5>
                            <p><a href="company-details.html">{{ $jobApplication->job->company->location }}</a></p>
                        </div>
                    </div>
                </div>
