        ...
        <div class="auto-container">
            ...
            $terms_and_conditions = [
                [
                    "name" => "introduction",
                    "title" => "Introduction",
                    "content" => "These Terms and Conditions (\"Terms\") govern your use of the website and services offered by [Company Name] (\"Company\", \"we\", \"us\", or \"our\"). By accessing or using the website or any of the services, you agree to be bound by these Terms. If you do not agree to all of the Terms, you may not use the website or any of the services."
                ],
                [
                    "name" => "definitions",
                    "title" => "Definitions",
                    "content" => "
                        <b>Account</b> Your account on the website where you can access and manage your profile, job applications, and visa application information.
                        <b>Content</b> Any information, data, text, images, videos, audio files, or other materials displayed on the website.
                        <b>Services</b> The job search and visa application assistance services offered by the Company.
                        <b>User</b> Any individual or entity that accesses or uses the website or any of the services.
                        <b>Website</b> The website operated by the Company at [website address]."
                ],
                [
