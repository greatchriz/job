    ...
    @section('content')
        ...
        <section class="tnc-section">
            <div class="auto-container">
                ...
                $terms_and_conditions = [
                    [
                        "name" => "introduction",
                        "title" => "Introduction",
                        "content" => "These Terms and Conditions \"Terms\" govern your use of the website and services offered by <b>Helpnow</b> \"Helpnow\", \"we\", \"us\", or \"our\". By accessing or using the website or any of the services, you agree to be bound by these Terms. If you do not agree to all of the Terms, you may not use the website or any of the services."
                    ],
                    ...
                    [
                        ...
                        "sub_content" => [
                            [
                                "title" => "Job Listings",
                                "content" => "<b>Helpnow</b> provides access to a database of job listings from various sources. <b>Helpnow</b> does not guarantee the accuracy or completeness of the job listings."
                            ],
                            [
                                "title" => "Job Applications",
                                "content" => "You may submit job applications through the website. <b>Helpnow</b> does not guarantee that your job applications will be received or considered by potential employers."
                            ],
                            [
                                "title" => "Fees",
                                "content" => "<b>Helpnow</b> may charge fees for certain job search services. The fees will be clearly displayed on the website."
                            ]
                        ]
                    ],
                    [
                        ...
                        "sub_content" => [
                            [
                                ...
                                "content" => "<b>Helpnow</b> provides information about visa requirements and application processes for various countries. <b>Helpnow</b> does not guarantee the accuracy or completeness of the visa information."
                            ],
                            [
                                "title" => "Visa Assistance",
                                "content" => "<b>Helpnow</b> may offer visa application assistance services for a fee. The services may include:
                            ...
                            [
                                "title" => "Visa Approval",
                                "content" => "<b>Helpnow</b> does not guarantee that your visa application will be approved. The decision to grant or deny a visa is solely at the discretion of the immigration authorities."
                            ]
                        ]
                    ],
            ...
            <div class="sec-title text-center" style="margin-top: 50px">
                <h2>Helpnow Terms of Service</h2>
