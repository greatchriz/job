 ...
 <section class="about-section-three">
  ...
  <section class="testimonial-section-two">
    <div class="container-fluid">
      ...
      <!-- Sec Title -->
      <div class="sec-title text-center">
        <h2>Your Global Compass</h2>
        <div class="text">At Polticventure, we believe that building a world without professional borders requires more than just technology. It takes a dedicated team of passionate individuals who share our vision of empowering talent around the globe. <br>Meet the dream team behind the platform</div>
      </div>
