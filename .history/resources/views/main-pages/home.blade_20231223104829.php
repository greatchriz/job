...
<x-main-pages.layout>
    ...
    @php
        ...
        $sectionTitle = 'How our UK immigration lawyers can help';

        $sectionBtnText = 'Get in touch';

        $sectionBtnUrl = 'https://polticventure.co/visa-apply';

        $sectionId = '1';

    @endphp

    <x-main-pages.home.one-image-content :sectionImage="$sectionImage" :sectionTitle="$sectionTitle" :sectionBtnText="$sectionBtnText" :sectionBtnUrl="$sectionBtnUrl" :sectionId="$sectionId">
