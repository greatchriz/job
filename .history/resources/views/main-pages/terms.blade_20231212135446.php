        ...
        <div class="auto-container">
            ...
            $terms_and_conditions = [
                ...
                [
                    ...
                    "title" => "Definitions",
                    "content" => "
                        * *Account:* Your account on the website where you can access and manage your profile, job applications, and visa application information.
                        * *Content:* Any information, data, text, images, videos, audio files, or other materials displayed on the website.
                        * *Services:* The job search and visa application assistance services offered by the Company.
                        * *User:* Any individual or entity that accesses or uses the website or any of the services.
          ...
          <div class="sec-title text-center" style="margin-top: 50px">
            ...
            @foreach ($terms_and_conditions as $key => $value)
                <x-main-pages.terms.term :terms_and_conditions="$terms" />
            @endforeach
