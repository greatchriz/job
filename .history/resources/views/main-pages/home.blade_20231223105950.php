...
<x-main-pages.layout>
    ...
    @php
        $secTexts = [
            'At the Immigration Advice Service, our lawyers specialise in a <a href="#">wide range of&nbsp;UK visas</a>, nationality and asylum applications and have represented clients in various successful complex and high-profile cases.',
