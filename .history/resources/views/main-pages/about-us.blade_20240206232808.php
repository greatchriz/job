    ...
    @section('content')
        ...
        <section class="work-section style-two">
            ...
            <div class="sec-title text-center">
                ...
                <div class="text">
                    Imagine a world where talent knows no bounds, where ambition transcends borders, and opportunities bloom like vibrant blossoms across every continent. This is the world Helpnow invites you to explore – not just a job board, but a springboard to launch your international odyssey.
                </div>

                <div class="text">
                    We're not simply connecting you with jobs; we're weaving a tapestry of possibilities, each thread a chance to paint your own masterpiece on the global canvas. Whether you're a seasoned maestro seeking a new concerto or a budding virtuoso eager to debut on the world stage, Helpnow orchestrates your symphony of success.
                </div>
            </div>
                ...
                @php
                    $workBlocks = [
                        ...
                        [
                            ...
                            "text" => "Helpnow knows that a dream job often comes with a symphony of logistical challenges. Fear not, intrepid traveler! We're your one-stop visa whisperer, your residence permit alchemist, and your flight-booking fairy godmother. We'll smooth the wrinkles out of immigration forms, conjure up the perfect apartment in your new city, and whisk you away on the wings of convenience to your new destination."
                        ],
                        [
                            "image" => "/images/resource/work-2.png",
                            "title" => "A World of Welcome",
                            "text" => "Landing in a new country can feel like stepping onto a stage with an unfamiliar script. But with Helpnow, you'll never have to face the spotlight alone. Our network of local partners extends a warm hand, offering language courses, cultural insights, and a community of like-minded adventurers who've already mastered the art of navigating their own global journeys"
                        ],
                        [
                            "image" => "/images/resource/work-3.png",
                            "title" => "A Chorus of Success Stories",
                            "text" => "The Helpnow stage isn't just a platform for individual achievements; it's a testament to the transformative power of global connections. We're proud to be the stage where Maria, a passionate coder from Mexico, landed her dream job at a Silicon Valley tech giant. We celebrate with Akash, a young engineer from India, who used our platform to secure a life-changing internship in Germany. These are just a few notes in the grand symphony of Helpnow success stories, each one a testament to the power of ambition, opportunity, and a little bit of our magic."
                        ]
                    ]
                @endphp
        ...
        <section class="work-section style-two">
            <div class="auto-container">
            <div class="sec-title text-center">
                <h2>Why Register as a Candidate on Helpnow?</h2>
                <div class="text">
                    Are you a driven professional seeking to launch your career in the vibrant Netherlands? Look no further than Helpnow, your one-stop platform to connect with exciting opportunities and build a fulfilling future. Forget the limitations of traditional job boards – here, you'll discover a curated selection of positions across diverse industries and locations, perfectly aligned with your skills and aspirations.
                </div>
            </div>
        ...
        <section class="work-section style-two">
            ...
            <div class="sec-title text-center">
                <h2>How It Works?</h2>
                <div class="text">Ready to ditch the map and navigate your own global career adventure? <br>Buckle up, because Helpnow's got your compass! <br> Here's how it works</div>
            </div>
            ...
            @php
                $works = [
                    ...
                    [
                        ...
                        "text" => "The journey doesn't stop here! Helpnow stays by your side. Access exclusive career resources, skill-up with curated workshops, and connect with mentors who've already conquered their global goals."
                    ],
        ...
        <section class="testimonial-section-two">
            ...
            <!-- Sec Title -->
            <div class="sec-title text-center">
                <h2>The Helpnow Dream Team: Your Global Compass
                <div class="text">At Helpnow, we believe that building a world without professional borders requires more than just technology.<br> It takes a dedicated team of passionate individuals who share our vision of empowering talent around the globe. <br>Meet the dream team behind the platform</div>
            </div>
            ...
            <div class="carousel-outer">
                ...
                $teamMembers = [
                        [
                            ...
                            "description" => "Our fearless leader, with a strategic mind and a heart for global connection, guides Helpnow towards a future where talent knows no bounds."
                        ],
                        [
        ...
        <section class="testimonial-section-two">
            ...
            <div class="sec-title text-center">
                ...
                <div class="text">From navigating visa applications to landing their dream jobs across the globe, Helpnow has helped countless individuals achieve their career aspirations. Here's what they have to say</div>
            </div>
                    ...
                    @php
                        $testimonials = [
                            [
                                ...
                                "description" => "I landed my dream job in Silicon Valley, thanks to Helpnow's expert career coaching and personalized job recommendations. They even helped me navigate the visa process!",
                                "title" => "Helpnow wasn't just a platform, it was a launchpad!"
                            ],
                            [
                                "image" => "/images/resource/testimonials/testi-thumb-2.jpg",
                                "name" => "Maria (Mexico),",
                                "designation" => "Marketing Manager",
                                "description" => "I never thought I'd work in Paris. Helpnow not only helped me find the perfect job, but their relocation support made the transition seamless. Now, I'm living the croissant dream!",
                                "title" => "From Tokyo to Paris, Helpnow opened the world to me."
                            ],
                            [
                                "image" => "/images/resource/testimonials/testi-thumb-3.jpg",
                                "name" => "Hiro (Japan),",
                                "designation" => "Cultural Consultant",
                                "description" => "Helpnow's community is incredible. I've connected with professionals from all over the world, sharing experiences and supporting each other's journeys. It's like having a global family.",
                            ...
                            [
                                ...
                                "description" => "I was stuck in a dead-end job. Helpnow's career guidance helped me discover my passion for graphic design. Now, I'm freelancing for clients around the globe!",
                            ...
                            [
                                ...
                                "description" => "Helpnow gave me the freedom to work from anywhere. Their visa and relocation support helped me find my perfect island home, and their global network keeps me connected to clients worldwide.",
                                "title" => "The world is my office, thanks to Helpnow."
                            ]
                        ]
                    @endphp
