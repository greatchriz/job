  ...
  <section class="testimonial-section-two">
    <div class="container-fluid">
      ...
      <div class="sec-title text-center">
        ...
        <div class="text">From navigating visa applications to landing their dream jobs across the globe, Polticventure has helped countless individuals achieve their career aspirations. Here's what they have to say</div>
      </div>
      ...
      <div class="carousel-outer">
        ...
        <div class="testimonial-carousel owl-carousel owl-theme">
            ...
            "Polticventure wasn't just a platform, it was a launchpad!"

            Akash (India), Software Engineer: "I landed my dream job in Silicon Valley, thanks to Polticventure's expert career coaching and personalized job recommendations. They even helped me navigate the visa process!"

            "From Tokyo to Paris, Polticventure opened the world to me."

            Maria (Mexico), Marketing Manager: "I never thought I'd work in Paris. Polticventure not only helped me find the perfect job, but their relocation support made the transition seamless. Now, I'm living the croissant dream!"

            "More than a job, it's a global community."

            Hiro (Japan), Cultural Consultant: "Polticventure's community is incredible. I've connected with professionals from all over the world, sharing experiences and supporting each other's journeys. It's like having a global family."

            "They believed in me before I even did."

            Emily (USA), Graphic Designer: "I was stuck in a dead-end job. Polticventure's career guidance helped me discover my passion for graphic design. Now, I'm freelancing for clients around the globe!"

            "The world is my office, thanks to Polticventure."

            Omar (Egypt), Remote Entrepreneur: "Polticventure gave me the freedom to work from anywhere. Their visa and relocation support helped me find my perfect island home, and their global network keeps me connected to clients worldwide."
            ...
            @php
                $testimonials = [
                    [
                        "image" => "/images/resource/testimonials/testi-thumb-1.png",
                        "name" => "Akash (India),",
                        "designation" => "Software Engineer",
                        "description" => "I landed my dream job in Silicon Valley, thanks to Polticventure's expert career coaching and personalized job recommendations. They even helped me navigate the visa process!",
                        "title" => "Polticventure wasn't just a platform, it was a launchpad!"
                    ],
                    [
                        "image" => "/images/resource/testimonials/testi-thumb-2.png",
                        "name" => "Maria (Mexico),",
                        "designation" => "Marketing Manager",
                        "description" => "I never thought I'd work in Paris. Polticventure not only helped me find the perfect job, but their relocation support made the transition seamless. Now, I'm living the croissant dream!",
                        "title" => "From Tokyo to Paris, Polticventure opened the world to me."
                    ],
                    [
                        "image" => "/images/resource/testimonials/testi-thumb-3.png",
                        "name" => "Hiro (Japan),",
                        "designation" => "Cultural Consultant",
                        "description" => "Polticventure's community is incredible. I've connected with professionals from all over the world, sharing experiences and supporting each other's journeys. It's like having a global family.",
                        "title" => "More than a job, it's a global community."
                    ],
                    [
                        "image" => "/images/resource/testimonials/testi-thumb-4.png",
                        "name" => "Emily (USA),",
                        "designation" => "Graphic Designer",
                        "description" => "I was stuck in a dead-end job. Polticventure's career guidance helped me discover my passion for graphic design. Now, I'm freelancing for clients around the globe!",
                        "title" => "They believed in me before I even did."
                    ],
                    [
                        "image" => "/images/resource/testimonials/testi-thumb-5.png",
                        "name" => "Omar (Egypt),",
                        "designation" => "Remote Entrepreneur",
                        "description" => "Polticventure gave me the freedom to work from anywhere. Their visa and relocation support helped me find my perfect island home, and their global network keeps me connected to clients worldwide.",
                        "title" => "The world is my office, thanks to Polticventure."
                    ]
                ]
            @endphp
