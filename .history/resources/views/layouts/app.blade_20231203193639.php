                    ...
                    <div class="main-menu">
                        ...
                        <ul class="menu-list">
                            ...
                            <li class="menu-item-has-children">
                                <a href="#" class="drop-down">Find Jobs</a><i
                                    class="bi bi-plus dropdown-icon"></i>
                                <ul class="sub-menu">
                                    <li><a href="category.html">Job Category</a></li>
                                    <li><a href="job-listing1.html">Job Listing
                                            01</a></li>
                                    <li><a href="job-listing2.html">Job Listing
                                            02</a></li>
                                    <li><a href="job-details.html">Job Details</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="#" class="drop-down">Pages</a><i
                                    class="bi bi-plus dropdown-icon"></i>
                                <ul class="sub-menu">
                            ...
                            <li class="menu-item-has-children">
                                <a href="#">Company</a><i
                                    class="bi bi-plus dropdown-icon"></i>
                                <ul class="sub-menu">
                                    <li><a href="company-listing1.html">Company
                                            Listing 01</a></li>
                                    <li><a href="company-listing2.html">Company
                                            Listing 02</a></li>
                                    <li><a href="company-details.html">Company
                                            Details</a></li>
                                    <li><a href="company-dashboard.html">Company
                                            Dashboard</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="blog-standard.html">Blog
                                            Standard</a></li>
                                    <li><a href="blog-right-sidebar.html">Blog
                                            Right Sidebar</a></li>
                            ...
                            <li>
                                <div class="btn-group dropdown">
                                    <div
                                        ...
                                        role="button" id="dropdownMenuButton2"
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="menu-container">
                                    <ul>
                                        ...
                                        <li><a href="job-listing1.html">Browse Jobs
                                                <i class="bx bx-up-arrow-alt"></i></a></li>
                                        <li><a href="dashboard.html">Candidate
                                                Dashboard <i
                                                    class="bx bx-up-arrow-alt"></i></a></li>
                                ...
                                <div class="menu-container">
                                    <ul>
                                        ...
                                        <li><a href="pricing-plan.html">Job Packages
                                                <i class="bx bx-up-arrow-alt"></i></a></li>
                                        <li><a href="job-listing1.html">Jobs
                                                Featured <i
                                                    class="bx bx-up-arrow-alt"></i></a></li>
