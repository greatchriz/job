        ...
        <div class="edit-profile-inner">
            <div class="form-wrapper">
                <ul class="nav nav-tabs" id="myTab"
                    ...
                    <x-tab-button active="active" id="basic-tab" label="Basic Information" />
                    <x-tab-button active="active" id="profile-tab" label="Profile" />
                    <x-tab-button active="active" id="contact-tab" label="Education" />
                    <x-tab-button active="active" id="professional-tab" label="Professional" />
                    <x-tab-button active="active" id="experience-tab" label="Experience" />
