                ...
                <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-inner">
                                        <button
                                            class="secondary-btn-2 lg-btn w-unset"
                                ...
                                <div class="col-6">
                                    <div class="form-inner">
                                        <button
                                            class="warning-btn-2 lg-btn w-unset"
                        ...
                        <form
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div
                                        class="form-inner mb-25">
                                        <label for="perAddress">Permanent
                                            Address*</label>
                                        <div class="input-area">
                                            <img
                                                src="assets/images/icon/home-2.svg"
                                    ...
                                    <div
                                        ...
                                        <div class="input-area">
                                            ...
                                            <select
                                                ...
                                                <option
                                                    value="2">Widowed</option>
                                                <option
                                                    value="4">Divorced</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="input-area">
                                            ...
                                            <select
                                                class="select1">
                                                <option
                                                    value="0">Christianity</option>
                                                <option
                                                    value="1">Islam</option>
                                                <option
                                                    value="2">Buddhism</option>
                                                <option
                                                    value="3">Sikhism</option>
                                                <option
                                                    value="4">Judaism</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="contact"
                        ...
                        <form
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div
                                            class="form-inner mb-25">
                                            <label
                                                for="institute">Institute/University*</label>
                                            <div
                                                class="input-area">
                                                <img
                                    ...
                                    <div class="col-md-6">
                                        <div
                                            class="form-inner mb-20">
                                            <label
                                                for="datepicker10">Starting
                                                Period*</label>
                                            <div
                                                class="input-area">
                                                <img
                            ...
                            <div
                                class="add-remove-btn d-flex align-items-center justify-content-between mb-50">
                                <div class="add-row">
                                    <button type="button"
                                        class="add-education-row">Add
                                        Education+</button>
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div
                                            class="form-inner mb-25">
                                            <label
                                                for="desigation">Designation*</label>
                                            <div
                                                class="input-area">
                                                <img
                                                    src="assets/images/icon/designation-2.svg"
                                    ...
                                    <div class="col-md-12">
                                        <div
                                            class="form-inner mb-20">
                                            <label
                                                for="description1">Responsibility**</label>
                                            <textarea
                                                name="description"
                                                id="description1"
                                                placeholder="Write Your Responsibility..."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
