                    ...
                    <div class="tab-pane fade show active"
                        ...
                        <form
                            ...
                            <div class="row">
                                ...
                                {{-- check if the loop has tag 1 and call the component --}}

                                   @if ($textFormInput->tag == 1)
                                ...
                                @foreach ($selectFormInputs as $selectFormInput)
                                    @if($selectFormInput->tag == 1)
                                        <x-form-input.select
                                            :id="$selectFormInput->name"
                                            :label="$selectFormInput->label"
                                            :name="$selectFormInput->name"
                                            :options="$selectFormInput->options"
                                        />
