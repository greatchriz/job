                        ...
                        <form
                            ...
                            <div class="row">
                                ...
                                @foreach ($textFormInputs as $textFormInput)
                                    <x-form-input.input-wrapper :id="$textFormInput->name" :icon="$textFormInput->icon" :name="$textFormInput->name" :type="$textFormInput->type" :placeholder="$textFormInput->placeholder" :label="$textFormInput->label />
                                @endforeach

                                @foreach ($selectFormInputs as $selectFormInput)
                                        <x-form-input.select :selectFormInput="$selectFormInput" />
                                @endforeach
