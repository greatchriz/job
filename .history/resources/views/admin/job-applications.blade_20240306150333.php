                ...
                <div class="news-block">
                    <div class="inner-box">
                        ...
                        <div class="lower-content b-bottom">
                            <h3 class="b-bottom mtp-15"><a href="#">User Email:&nbsp; &nbsp; <b>{{ $job->user->email }}</b></a></h3>
                            <h3 class="b-bottom mtp-15"><a href="#">Date Applied:&nbsp; &nbsp; <b>{{ $job->created_at }}</b></a></h3>
                            {{-- jobapplication cv --}}
                            <a href="{{ route('job-applications.view-cv', $job->id) }}" class="theme-btn btn-style-four mtp-15">
                                View CV</a>
                        </div>

                        <div class="content mtp-40">
                            <span class="company-logo b-bottom mtp-15">
                                <img src="{{ $job->job->companyLogo }}" alt>
                            </span>
                            <h4><a href="{{ route('admin.jobs.edit', $job->job->id) }}">{{ $job->job->title }}</a></h4>
