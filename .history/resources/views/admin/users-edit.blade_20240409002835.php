    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="column col-md-12">
                <form action="{{ route('admin.users.update', $user->id) }}" method="POST" class="default-form">
                    ...
                    {{-- <div class="form-group">
                        ...
                        <input type="number" name="account_balance" placeholder="Account Balance" value="{{ $user->account_balance }}">
                    </div> --}}
...
{{--
                    ...
                    <div class="form-group">
                        <button class="theme-btn btn-style-one" type="submit">Update User</button>
                      </div>
