        ...
        <div class="inner-box">
            <div class="content">
                ...
                <p style="font-weight: 700; margin-bottom: 5px">{{ $user->email }}</p>
                    ...
                    <p style="font-weight: 500; margin-bottom: 10px; font-size: 20px ">{{ $user->account_balance }}

                    <span style="margin-left:10px">
                        <a href="{{ route('admin.users.edit', $user->id) }}" class="theme-btn btn-style-three">Update Balance</a>
                    </span>
                    </p>
