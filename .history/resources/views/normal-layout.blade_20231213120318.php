                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul>
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul>
                                                    <li><a href="candidates-single-v1.html">Candidates Single v1</a>
                                                    </li>
                                                    <li><a href="candidates-single-v2.html">Candidates Single v2</a>
                                                    </li>
                                                    <li><a href="candidates-single-v3.html">Candidates Single v3</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        ...
                                        <span>
                                            <span class="contact-info">
                                                <span class="phone-num"><span>Call us</span><a href="tel:1234567890">123
                                                        456 7890</a></span>
                                                <span class="address">329 Queensberry Street, North Melbourne VIC
