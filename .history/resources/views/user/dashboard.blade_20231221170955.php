...
<div class="row">
    ...
    <x-dashboard.ui-item uiColor="ui-red" uiIcon="la-file-invoice" uiTitle="Jobs Applied" uiValue="{{ $userActivities->count() }}" link="appliedjobs"/>

    <x-dashboard.ui-item uiColor="ui-yellow" uiIcon="la-comment" uiTitle="Messages" uiValue="{{ $userMessages->count() }}" link="usermessages" />

    <x-dashboard.ui-item uiColor="ui-green" uiIcon="la-bookmark" uiTitle="Flights Booked" uiValue="{{ $flightsBooked->count() }}" link="usermessages" />
        ...
        <div class="notification-widget ls-widget">
            ...
            <div class="widget-content">
                <ul class="notification-list">
                    <li><span class="icon flaticon-briefcase"></span> <strong>Wade Warren</strong> applied for a job
                        <span class="colored">Web Developer</span></li>
                    <li><span class="icon flaticon-briefcase"></span> <strong>Henry Wilson</strong> applied for a job
                        <span class="colored">Senior Product Designer</span></li>
                    <li class="success"><span class="icon flaticon-briefcase"></span> <strong>Raul Costa</strong>
                        applied for a job <span class="colored">Product Manager, Risk</span></li>
                    <li><span class="icon flaticon-briefcase"></span> <strong>Jack Milk</strong> applied for a job <span
                            class="colored"
                        >Technical Architect</span></li>
