            ...
            enctype="multipart/form-data">
                ...
                <div class="uploading-outer">
                    <div class="uploadButton">
                        <input class="uploadButton-input" type="file" name="cv" accept="image/*, application/pdf" id="upload" multiple />
                        <label class="uploadButton-button ripple-effect" for="upload">Upload Your CV</label>
                        <span class="uploadButton-file-name"></span>
                    </div>
                    <div class="text">Max file size is 1MB, Minimum dimension: 330x300 And Suitable files are .jpg & .png</div>

                    @error('cv')
                    <div class="message-box error" style="display: none;">
                        <p>{{ $message }}</p>
                ...
                <div class="uploading-outer">
                    <div class="uploadButton">
                        <input class="uploadButton-input" type="file" name="application_letter" accept="image/*, application/pdf" id="application_letter" multiple  name="application_letter"/>
                        <label class="uploadButton-button ripple-effect" for="upload">Upload Your Application Letter</label>
                        <span class="uploadButton-file-name"></span>
                    </div>
                    <div class="text">Max file size is 1MB, Minimum dimension: 330x300 And Suitable files are .jpg & .png</div>
