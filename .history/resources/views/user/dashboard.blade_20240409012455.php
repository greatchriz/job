...
<div class="row">
    ...
    <x-dashboard.ui-item uiColor="ui-green" uiIcon="la-file-invoice" uiTitle="Account Balance" :uiValue="$user->balance" link="accountbalance"/>
    ...
    <x-dashboard.ui-item uiColor="ui-green" uiIcon="la-bookmark" uiTitle="Flights Booked" uiValue="{{ $flightsBooked->count() }}" link="userflights" />
