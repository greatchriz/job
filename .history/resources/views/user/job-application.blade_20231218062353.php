...
<div class="row">
    <div class="col-lg-12">
        ...
        <div
            class="job-overview-two"
            style="background: #ffffff; border-radius: 8px; box-shadow: 0px 6px 15px rgba(64, 79, 104, 0.05);"
        >
            <h4>Job Details</h4>
            <ul>
                <li>
                ...
                <div class="widget-content">
                    ...
                    >
                        ...
                        <div class="uploading-outer">
                            ...
                            <div class="text">Max file size is 1MB, Minimum dimension: 330x300 And Suitable files are
                                .jpg & .png</div>
