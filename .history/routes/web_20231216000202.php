...
// get the file contents of public/jobs.html
   ...
   //convert the h2Elements to an array
   ...
   $companyLogoSrc = $xpath->query('//div[@class="card-job-avatar"]');

   foreach ($companyLogoSrc as $companyLogo) {
      $companyLogoSrc[] = $companyLogo->nodeValue;
   }
   ...
   // add all the array elements in a single array which are $h2Contents, $companyLogoSrc, $cardJobCountry

   $jobTitleArray = array_combine($h2Contents,  $cardJobCountry);
