...
class JobApplicationController extends Controller
{
    ...
    public function reject(Request $request, JobApplication $jobApplication)
    {
        ...
        Mail::to($userMail)->send(new CvRejected($jobApplicationData));
    ...
    {
        $file_path = public_path('uploads/' . $jobApplication->cv);
        $file_name = $jobApplication->cv;
